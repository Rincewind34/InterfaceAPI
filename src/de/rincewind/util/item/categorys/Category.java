...
public class Category {
	...
	/**
	 * Category: This class specifies a category of an item
	 */
	public Category() {
	 ...
	 * @return If this category contains the given material
	 */
	...
	@SuppressWarnings("deprecation")
	/**
	 * @param material The material-data to check
	 * @return If this category contains the given material-data
	 */
	...
	@SuppressWarnings("deprecation")
	/**
	 * Adds an new material to this category
	...
	/**
	 * @param material The MaterialData to add to this category
	 */
	...
	/**
	 * Imports all MaterialDatas from a category
	 * 
	...
	/**
	 * @reutrn A list of all MaterialData's, which is contained by the category
	 */
