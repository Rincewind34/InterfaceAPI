...
public abstract interface Element extends EventBased, UserMemory, Sized {
	...
	public static final ElementComponentType<Boolean> INSTRUCTIONS = new ElementComponentType<>(boolean.class, "instructions");
	...
	/**
	 * If the x or y coordinate is negative or greater than the size of for
	 * example the window added this element to, this element may not be
	 * rendered.
	 * 
	 * @param point
	 *            to set
	 ...
	 * {@link InventoryAction}-s for example like pickup or drop from/to the
	 * slot. By the default all actions are canceled.
	 * 
	 * @param blocker
	 *            to set
	 * 
	 * @throws NullPointerException
	 *             if the blocker is null
	 */
	 ...
	 * {@link WindowColorable} with the background of the window this element is
	 * added to.
	 * 
	 * @param visible
	 *            hiding this element if the value is <code>false</code>.
	 */
	...
	public abstract boolean showInstructions();
