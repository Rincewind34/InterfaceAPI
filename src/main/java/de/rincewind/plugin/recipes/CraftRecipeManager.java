...
import de.rincewind.api.util.recipes.Recipe;
import de.rincewind.api.util.recipes.RecipeFurnace;
import de.rincewind.api.util.recipes.RecipeManager;
import de.rincewind.api.util.recipes.RecipePacket;
import de.rincewind.api.util.recipes.RecipeShaped;
import de.rincewind.api.util.recipes.RecipeShapeless;
import de.rincewind.api.util.recipes.RecipeType;
